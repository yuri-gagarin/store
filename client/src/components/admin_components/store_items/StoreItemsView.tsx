...
import StoreItemsManageHolder from "./storeItem_manage/StoreItemsManageHolder";
import StoreItemsPreviewHolder from "./storeItem_preview/StoreItemsPreviewHolder";
...
const StoreItemsView: React.FC<{}> = (props): JSX.Element => {
  ...
  return (
    <div id="adminStoreItemsViewHolder">
      ...
      <Switch>
        <Route path="/admin/home/my_store_items/all">
          <Spacer width="100%" height="100px"/>
          <StoreItemsPreviewHolder state={state} dispatch={dispatch} />
        </Route>
        <Route path="/admin/home/my_store_items/create">
          <Spacer width="100%" height="100px" />
          <StoreItemFormHolder state={state} dispatch={dispatch} />
        </Route>
        <Route path="/admin/home/my_store_items/manage">
